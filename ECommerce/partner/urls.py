...
urlpatterns = [path('registration/',views.Registration_CBV.as_view(form_title="User Registration"),name="user_registration"),\
        path('registration/update/',views.registration_update_form_view,name="profile_registration_update")]
